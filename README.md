...
In practice, this means you can associate multiple numeric tags with a specific boundary condition and use any of those tags when defining your geometry. This shifts control to the user, making it easier to adapt simulations to different meshing or tagging conventions.
